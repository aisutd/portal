            ...
            {personalFields.map((label) =>
              label === "Resume *" ? (
                <div key={label} className="flex flex-col gap-[6px]">
                  <label className="font-mobile-body  font-bold text-ink">
                    {label}
                  </label>
                  <a
                    href="/api/profile/resume/download"
                    className="flex h-[40px] items-center rounded-[10px] bg-field px-[13px] font-mono  text-ink transition-colors hover:text-brand focus:outline-none focus:ring-2 focus:ring-brand/40"
