...
export function MobileDashboard({ userId, userName, nextRsvp, announcements }: MobileDashboardProps) {
  return (
    <MobileScreen>
      <h1 className="font-mobile-display  font-bold text-brand">
          ...
          <>
            <div className="flex flex-col gap-[4px]">
              <div className="mb-[4px] flex items-center justify-between">
                <p className="font-mono  uppercase tracking-[2px] text-ink-faint">
      ...
      <Suspense
        fallback={
          <div className="flex min-h-[150px] items-center justify-center rounded-2xl bg-white">
            <span className="font-mobile-body  text-ink-muted">
