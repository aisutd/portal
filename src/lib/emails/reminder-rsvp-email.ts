...
import { formatDaysAway } from "../dashboard-utils";
    ...
    const mailOptions = {
      ...
      <div style="background-color: #faf7ee; padding: 32px 16px; font-family: Inter, Arial, sans-serif;">
        <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border: 1px solid #c0bfbc; border-radius: 8px; padding: 32px; color: #16161c; line-height: 1.5;"> 
          ...
          <h2 style="color: #16161c; font-size: 24px; font-weight: 700; letter-spacing: -0.05em; margin-top: 0; margin-bottom: 16px;">Your Event is Coming Up!</h2> 
          
          <p style="font-size: 14px; color: #16161c; margin-bottom: 12px;">Hi <strong>${userName}</strong>,</p> 
          <p style="font-size: 14px; color: #16161c; margin-bottom: 20px;">Your RSVP'd event <strong>${event.title}</strong> is ${daysAway}! </p> 
          ...
          <div style="text-align: center; margin: 24px 0;">
            <a href="https://portal.aisutd.org/events/${eventId}" style="background-color: #2f5fe8; color: #ffffff; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: 700; font-size: 15px; display: inline-block;">View Ticket & Event Details</a>
          </div>
          ...
          <p style="font-size: 14px; color: #55555f; margin-bottom: 12px;">You will also receive a QR code that acts as your encrypted ticket to claim any items we give out during the event, such as food, drinks, merch, or something extra special! <strong>This QR code is required to claim any items.</strong> To find your personal QR code at any time, just head to your dashboard or click on this event from your events list page.</p>
          
          <p style="font-size: 14px; color: #55555f; margin-bottom: 12px;">Items are first-come, first-served, but we try our best to cover enough for the RSVP count 24 hours before the event.</p>
          
          <p style="font-size: 14px; color: #55555f; margin-bottom: 24px;">If you arrive late, you may ask an officer to check you in through your personal QR ticket.</p> 
          
          <p style="font-size: 14px; color: #16161c; margin-bottom: 16px;">We're so excited to see you there!</p> 
