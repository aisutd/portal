    ...
    const mailOptions = {
      ...
      <div style="background-color: #faf7ee; padding: 32px 16px; font-family: Inter, Arial, sans-serif;">
        <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border: 1px solid #c0bfbc; border-radius: 8px; padding: 32px; color: #16161c; line-height: 1.5;"> 
          ...
          <h2 style="color: #16161c; font-size: 24px; font-weight: 700; letter-spacing: -0.05em; margin-top: 0; margin-bottom: 16px;">You're all set!</h2> 
          
          <p style="font-size: 14px; color: #16161c; margin-bottom: 12px;">Hi <strong>${userName}</strong>,</p> 
          <p style="font-size: 14px; color: #16161c; margin-bottom: 20px;">Your RSVP for <strong>${event.title}</strong> has been confirmed.</p> 
          ...
          <p style="font-size: 14px; color: #16161c; margin-bottom: 16px;">We look forward to seeing you there.</p> 
