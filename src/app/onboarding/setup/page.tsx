...
export default async function SetupPage() {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col items-center bg-[linear-gradient(to_bottom,#f2a968_0%,#1f3aa3_30%,#1f3aa3_100%)] px-[24px] py-[60px]">
      ...
      <h1 className="mt-[24px] font-display text-[32px] font-bold leading-[34.56px] tracking-[-0.4px] text-white [font-variation-settings:'wdth'_100]">
        Complete Your Profile
      </h1>
      <p className="mt-[8px] max-w-[420px] text-center font-body text-[15px] font-normal leading-[22.5px] text-[#dfe6ff]">
